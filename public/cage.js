...
function preload ()
{
  this.load.image('ball', 'http://static.tumblr.com/48ce5e3ce708c0534df90579c2623e06/7owfufo/Ibsmjw6gd/tumblr_static_tumblr_mba30bbxap1rq17uyo1_400.png');

  this.load.text('bevelledcube', 'bevelledcube.obj');
  this.load.text('geosphere', 'geosphere.obj');
  this.load.text('implodedcube', 'implodedcube.obj');
  this.load.text('spike', 'spike.obj');
  this.load.text('torus', 'torus.obj');
}
